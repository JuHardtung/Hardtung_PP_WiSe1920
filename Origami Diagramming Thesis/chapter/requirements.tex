...
\end{itemize}
Even though these features are quite important for the later usability of Origrammer, the focus was first set on implementing all origami specific tools first, as this provided the biggest unique feature set when comparing to already existing vector programs.